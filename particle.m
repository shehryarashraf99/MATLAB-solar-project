...
Max_Stall_iterations=100;%default is NVARS
Max_iterations=100;
StepTolerance=0.05;
...
%    
  ...
  particleoptions.InitialSwarmMatrix=swarm_matrix;
[potential_tilt_angle{m},~]=particleswarm(objective,NVARS,lb,ub,particleoptions);
...
writecell(matrix,'particle.xlsx');
end
