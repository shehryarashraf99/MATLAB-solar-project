...
Mesh_Tolerance=10^-12;
Self_adjustment_weight=0.25; % default is 2.5
Social_Adjustment_weight=0.205; %default is 2.05
Max_Stall_iterations=100; %default is 20
StepTolerance=0.05;
InertiaRange=[0.004 0.009]; % previous is [0.04 0.09]
min_neighbours=0.04;
num_particles=50;
% std=0.5/3;
% mean=0;
...
[potential_tilt_angle{m},~]=fmincon(objective,Y{m},[],[],[],[],lb-0.04,ub+0.04,[],fminconoptions);
...
writecell(matrix,'fminimum.xlsx');
end
